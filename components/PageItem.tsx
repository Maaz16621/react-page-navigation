...
import { EllipsisVerticalIcon, InformationCircleIcon, DocumentIcon, CheckCircleIcon } from '../constants'; 
...
const PageItem: React.FC<PageItemProps> = ({
  ...
  const activeIconClasses = "text-slate-700"; // Icon color for active PageItem
  const inactiveIconClasses = "text-slate-500 group-hover:text-slate-600"; // Icon color for inactive PageItem, changes on parent hover
  ...
  const activeEllipsisClasses = "text-slate-500 hover:bg-slate-200"; // Ellipsis color for active PageItem
  const inactiveEllipsisClasses = "text-slate-400 hover:bg-slate-300/40 group-hover:text-slate-600"; // Ellipsis for inactive, uses group-hover for text color
